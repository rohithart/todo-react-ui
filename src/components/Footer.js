      ...
      <footer>
        <div className="footer-container">
          ...
          <div className="footer-section column-section">
            ...
            <span>
              rohithpoyyeri.com | &#169; {currentYear}
            </span>
          </div>

          <div className="footer-section column-section">
            <a href="/about" className="footerBanner" aria-label="About us">About us</a>
            <a href="/terms-and-condition" className="footerBanner" aria-label="Terms and condition">Terms and condition</a>
            <a href="/privacy-policy" className="footerBanner" aria-label="Privacy policy">Privacy policy</a>
          </div>
